  ...
  const getCategorySEO = () => {
    const seoData = {
      ...
      finance: {
        ...
        description:
          'Калькуляторы для финансов: ипотека, кредиты, инвестиции, конвертация валют',
        keywords:
          'финансы, ипотека, кредит, инвестиции, валюты, калькулятор, банк',
      },
      health: {
        title: 'Калькуляторы здоровья',
        description:
          'Калькуляторы здоровья: ИМТ, калории, процент жира и другие показатели',
        keywords:
          'здоровье, ИМТ, калории, фитнес, диета, вес, калькулятор здоровья',
      },
      other: {
        title: 'Полезные инструменты',
        description:
          'Различные калькуляторы и конвертеры: кулинария, единицы измерения, математические расчеты',
        keywords:
          'калькуляторы, конвертеры, кулинария, единицы измерения, математика, инструменты',
      },
    };
